...
export const squares: Square[] = [
  ...
  { 
    ...
    icon: getPropertyIcon('Büyülü Orman'),
  ...
  { 
    ...
    name: 'Ejder Yuvası', 
    description: 'Satılık Arsa',
    icon: getPropertyIcon('Ejder Yuvası'),
  ...
  { 
    ...
    name: 'Unicorn Vadisi', 
    description: 'Satılık Arsa',
    icon: getPropertyIcon('Unicorn Vadisi'),
  ...
  { 
    ...
    name: 'Sihirli Göl', 
    description: 'Satılık Arsa',
    icon: getPropertyIcon('Sihirli Göl'),
  ...
  { 
    id: 13, 
    type: 'arsa', 
    name: 'Hatiş\'in Bahçesi', 
    description: 'Satılık Arsa',
    icon: getPropertyIcon('Hatiş\'in Bahçesi'),
    property: { id: 7, name: 'Hatiş\'in Bahçesi', price: 220, rent: 50, level: 1, upgradePrice: 50, ownerId: null, baseRent: 50 }
  },
  ...
  { 
    ...
    name: 'Büyücü Kulesi', 
    description: 'Satılık Arsa',
    icon: getPropertyIcon('Büyücü Kulesi'),
  ...
  { 
    ...
    name: 'Antik Tapınak', 
    description: 'Satılık Arsa',
    icon: getPropertyIcon('Antik Tapınak'),
  ...
  { 
    ...
    name: 'Deniz Feneri', 
    description: 'Satılık Arsa',
    icon: getPropertyIcon('Deniz Feneri'),
  ...
  { 
    id: 21, 
    type: 'arsa', 
    name: 'Gökkuşağı Köprüsü', 
    description: 'Satılık Arsa',
    icon: getPropertyIcon('Gökkuşağı Köprüsü'),
  ...
  { 
    ...
    name: 'Ay Sarayı', 
    description: 'Satılık Arsa',
    icon: getPropertyIcon('Ay Sarayı'),
  ...
  { 
    ...
    name: 'Yıldız Kalesi', 
    description: 'Satılık Arsa',
    icon: getPropertyIcon('Yıldız Kalesi'),
  ...
  { 
    ...
    name: 'Gökyüzü Kulesi', 
    description: 'Satılık Arsa',
    icon: getPropertyIcon('Gökyüzü Kulesi'),
  ...
  { 
    ...
    name: 'Kristal Saray', 
    description: 'Satılık Arsa',
    icon: getPropertyIcon('Kristal Saray'),
